...
set_target_properties(scs::scsdir PROPERTIES
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib/libscsdir.so.3.2.0"
  IMPORTED_SONAME_RELEASE "libscsdir.so.3.2.0"
  )

list(APPEND _cmake_import_check_targets scs::scsdir )
list(APPEND _cmake_import_check_files_for_scs::scsdir "${_IMPORT_PREFIX}/lib/libscsdir.so.3.2.0" )
...
set_target_properties(scs::scsindir PROPERTIES
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib/libscsindir.so.3.2.0"
  IMPORTED_SONAME_RELEASE "libscsindir.so.3.2.0"
  )

list(APPEND _cmake_import_check_targets scs::scsindir )
list(APPEND _cmake_import_check_files_for_scs::scsindir "${_IMPORT_PREFIX}/lib/libscsindir.so.3.2.0" )
