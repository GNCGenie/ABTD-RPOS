...
extern void cpg_update_max_effort(cpg_float val);
extern void cpg_update_thrust_mat(cpg_int idx, cpg_float val);
extern void cpg_update_moment(cpg_int idx, cpg_float val);
