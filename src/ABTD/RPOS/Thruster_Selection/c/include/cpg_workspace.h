...
// Primal solution
typedef struct {
  cpg_float    *activation;   // Your variable activation
} CPG_Prim_t;
...
extern cpg_float cpg_params_vec[17];
...
// Canonical parameters
extern cpg_float canon_c[9];
extern cpg_float canon_c_conditioning[9];
extern cpg_csc canon_A;
extern cpg_csc canon_A_conditioning;
extern cpg_float canon_b[3];
extern cpg_float canon_b_conditioning[3];
extern cpg_csc canon_G;
extern cpg_csc canon_G_conditioning;
extern cpg_float canon_h[22];
extern cpg_float canon_h_conditioning[22];
...
extern cpg_float cpg_activation[4];

// Dual variables associated with user-defined constraints
extern cpg_float cpg_d0[4];
extern cpg_float cpg_d1[4];
