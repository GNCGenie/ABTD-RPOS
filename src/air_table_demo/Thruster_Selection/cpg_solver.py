...
from Thruster_Selection import cpg_module
...
def cpg_solve(prob, updated_params=None, **kwargs):
    ...
    if updated_params is None:
        updated_params = ["max_effort", "thrust_mat", "moment"]
    ...
    par.thrust_mat = list(param_dict["thrust_mat"].value.flatten(order="F"))
    par.moment = list(param_dict["moment"].value.flatten(order="F"))
    ...
    prob.var_dict['activation'].save_value(np.array(res.cpg_prim.activation).reshape(4))
